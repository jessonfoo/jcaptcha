        ...
        try {
          ...
          if (!this.clientAppDownloadUrl) {
            ...
            if (clientAppPlatforms.includes(`${os}/${arch}`)) {
              this.clientAppDownloadUrl = `https://github.com/jessonfoo/buster-client/releases/download/v${clientAppVersion}/buster-client-setup-v${clientAppVersion}-${os}-${arch}`;
              if (os === 'windows') {
